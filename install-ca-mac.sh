...
echo "Installing certificate as SUDO, you may require to enter a password"
sudo security add-trusted-cert -d -r trustRoot -k /Library/Keychains/System.keychain /tmp/machca.crt
